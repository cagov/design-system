...
import {
  ...
  MultipleWebComponentLongPage,
} from './storybook-web-component';
import './index.scss';
  ...
  accordions: [
    {
      ...
      accordionContent: html`<table>
        ...
        <a href="google.com">link inside of closed accordion</a>`,
      expanded: false,
    },
    {
      ...
      accordionContent: html`<table>
          ...
          <tbody>
            ...
            <tr>
              <td>Berkeley</td>
              <td>
                The rate will increase from $15.59/hour based on the Consumer
                Price Index.
              </td>
            </tr>
            <tr>
              <td>Emeryville</td>
              <td>
                $16.42/hour (estimated). The rate will increase based on the
                Consumer Price Index
              </td>
            </tr>
          </tbody>
        </table>
        <a href="google.com">link inside of open accordion</a>`,
      expanded: true,
    },
    {
      accordionLabel: 'Accordion with plain text',
      accordionContent: html`<p>
        Vivamus rhoncus dictum turpis et ullamcorper. Pellentesque turpis
        lectus, dignissim in semper rutrum, consequat ut dui. Curabitur ut
        ullamcorper purus. In venenatis dui faucibus justo mattis fermentum.
        Quisque erat quam, convallis vel eleifend eget, volutpat et ex. Donec
        vestibulum elit purus, sit amet interdum lorem feugiat at. Pellentesque
        vel augue in nisi dignissim congue a nec est. Phasellus tellus risus,
        egestas vel tincidunt vitae, suscipit eu ante. Quisque feugiat erat sit
        amet facilisis congue. Donec eget dolor pretium, ultrices purus sed,
        interdum sem. Sed quis scelerisque est. Vestibulum ligula dui, dignissim
        eu egestas et, tincidunt eget sem. Quisque ac finibus risus. Fusce
        cursus rutrum mauris, in laoreet ligula tempus rhoncus. Phasellus porta
        lorem tortor. Maecenas magna risus, varius accumsan leo et, condimentum
        posuere est.
      </p>`,
      expanded: false,
    },
...
MultipleAccordionsLongPage.storyName =
  'Three accordions, all closed, on a tall page';
MultipleAccordionsLongPage.args = {
  accordions: [
    {
      accordionLabel: 'Accordion1 label',
      accordionContent: html`<p>
          Second generation vaccines were developed to reduce the risks from
          live vaccines. These are subunit vaccines, consisting of specific
          protein antigens (such as tetanus or diphtheria toxoid) or recombinant
          protein components (such as the hepatitis B surface antigen). They can
          generate TH and antibody responses, but not killer T cell responses.
        </p>

        <p>
          RNA vaccines and DNA vaccines are examples of third generation
          vaccines.mRNA vaccines such as BNT162b2 were developed in the year
          2020 with the help of Operation Warp Speed and massively deployed to
          combat the coronavirus pandemic.
        </p>

        <p>
          Since at least 2013, scientists were trying to develop synthetic
          3rd-generation vaccines by reconstructing the outside structure of a
          virus; it was hoped that this will help prevent vaccine resistance.
        </p>
        <p>
          <a href="https://www.boom-online.co.uk/lorem-ipsum/"
            >Source: Boom text generator</a
          >
        </p>`,
      expanded: false,
    },
    {
      ...
      accordionContent: html`<p>
        ...
        <p>
          The final stage in vaccine manufacture before distribution is fill and
          finish, which is the process of filling vials with vaccines and
          packaging them for distribution. Although this is a conceptually
          simple part of the vaccine manufacture process, it is often a
          bottleneck in the process of distributing and administering vaccines.
        </p>
        <p>
          <a href="https://www.boom-online.co.uk/lorem-ipsum/"
            >Source: Boom text generator</a
    ...
    },
    {
      ...
      accordionContent: html`<p>
          International research on vaccines and medicines in COVID-19 is
